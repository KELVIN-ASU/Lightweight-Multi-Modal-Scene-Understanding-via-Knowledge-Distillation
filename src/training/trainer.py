...
#     def reset(self): self.confusion = np.zeros((self.num_classes, self.num_classes), dtype=np.int64)
...
#         self.history = {"train_loss": [], "train_miou": [],
#                         "val_loss": [], "val_miou": [],
#                         "lr": []}
...
#         print(f"🔄 Resumed from {path}, starting at epoch {start_epoch}, best mIoU {self.best_miou:.3f}")
#         return start_epoch
